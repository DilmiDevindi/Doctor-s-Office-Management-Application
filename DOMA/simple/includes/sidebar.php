        ...
        <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
          <ul class="nav" id="side-menu">
            <li>
             ...
             <li>
              <a href="add-customer.php"><i class="fa fa-users nav_icon"></i>Patient<span class="fa arrow"></span> </a>
              <ul class="nav nav-second-level collapse">
                <li>
                  <a href="add-customer.php">Add Patient</a>
                </li>
                <li>
                  <a href="customer-list.php">Patient List</a>
                </li>
              </ul>
              <!-- /nav-second-level -->
            </li>
